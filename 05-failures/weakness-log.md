...
<!-- AUTO-MANAGED: 日次セッションのレビューから追記されます。手で並べ替えないこと -->
...
| W012 | ページングにおけるOFFSET方式の課題とカーソル方式との使い分けを説明できない | Coding / Go / Next.js | Med | Open | 2026-09-11 | 2026-09-20 | — |
| W013 | レイヤー分離の目的を「関数を軽くする」ではなく変更理由と責務の分離として説明できない | Layered Architecture | Med | Open | 2026-09-11 | 2026-09-20 | — |

## Closed

| ID | Weakness | Track | Closed | Evidence |
|---|---|---|---|---|
| — | — | — | — | — |
