...
| 言語 | 3 | Go / context；Next.js / Server/Client Component；Go / error handling | なし |
...
<!-- eos:context date=2026-09-22 track=Layered Architecture format=Explain level=L1
     targets=W005
