...
|---|---|---|---|
| AI | 3 | 生成AIの仕組み概要（Transformer, LLM, RAG, ファインチューニング）；法制度と倫理（EU AI Act, 日本の指針、ガバナンス）；リスク（幻覚、著作権、秘密漏洩、バイアス） | なし |
| 言語 | 3 | Go / error handling；Next.js / Server/Client Component；Python / dataclass/Pydantic | なし |
| ネットワーク | 2 | 6章 Webサーバ側の処理；4章 アクセス回線とプロバイダ | なし |
...
<!-- eos:context date=2026-09-19 track=DB / Table Design format=Explain level=L1
     targets=W001
